...
public class CsjRenderDataConverter implements AdvanceRFADData {
    ...
    public CsjRenderDataConverter(TTFeedAd csjData, SdkSupplier sdkSupplier) {
        try {
...
//    }
    ...
    public boolean isDownloadAD() {
        try {
            ...
            return adType == TTAdConstant.INTERACTION_TYPE_DOWNLOAD;
        } catch (Throwable e) {
            e.printStackTrace();
        }
        return false;
...
//        String getFunctionDescUrl();
        ...
        public String getFunctionDescUrl() {
            try {
                return mCsjData.getComplianceInfo().getFunctionDescUrl();
            } catch (Throwable e) {
                e.printStackTrace();
            }
            return "";
