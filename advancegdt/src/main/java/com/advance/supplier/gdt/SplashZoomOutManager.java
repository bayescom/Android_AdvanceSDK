...
//            LogUtil.high(TAG + "deviceWidth = " + deviceWidth + "， context = " + context);
//
...
//
//            zoomOutMargin = BYDisplay.dp2px(6);
//            zoomOutAbove = BYDisplay.dp2px(100);
//            zoomOutPos = RIGHT;
...
//        try {
//            LogUtil.high(TAG + "zoomOut startZoomOut activity");
//            if (animationContainer == null || zoomOutContainer == null) {
//                LogUtil.e(TAG + "zoomOut animationContainer or zoomOutContainer is null");
//                return null;
//            }
//            if (splashAD == null || splashView == null) {
//                LogUtil.e(TAG + "zoomOut splashAD or splashView is null");
//                return null;
//            }
//            //先把view按照原来的尺寸显示出来
...
//
//            AdvanceUtil.removeFromParent(splashView);
...
//            LogUtil.max(TAG + "splashView x = " + x + "，y = " + y);
//            splashView.setX(x);
//            splashView.setY(y);
//        } catch (Throwable e) {
//            e.printStackTrace();
...
//            }
//            LogUtil.high(TAG + "zoomOut width:" + zoomOutWidth + " height:" + zoomOutHeight);
//
...
//
//            LogUtil.max(TAG + "zoomOut animationContainerWidth:" + animationContainerWidth + " " +
//                    "animationContainerHeight:" + animationContainerHeight);
//            LogUtil.max(TAG + "zoomOut splashScreenX:" + splashScreenPos[0] + " splashScreenY:" + splashScreenPos[1]);
//            LogUtil.high(TAG + "zoomOut splashWidth:" + fromWidth + " splashHeight:" + fromHeight);
//            LogUtil.max(TAG + "zoomOut animationDistX:" + animationDistX + " animationDistY:" + animationDistY);
//
...
//                            LogUtil.high(TAG + "zoomOut onAnimationStart");
//                            if (callBack != null) {
...
//                            LogUtil.high(TAG + "zoomOut onAnimationEnd");
//                            AdvanceUtil.removeFromParent(splash);
//                            splash.setScaleX(1);
//                            splash.setScaleY(1);
//                            splash.setX(0);
...
//                            LogUtil.max(TAG + "zoomOut distX:" + distX + " distY:" + distY);
//                            LogUtil.max(TAG + "zoomOut containerScreenX:" + zoomOutContainerScreenPos[0] + " " +
