...
public class GdtInterstitialAdapter extends AdvanceInterstitialCustomAdapter   {
    ...
    public void loadAd(Context context, Map<String, Object> localExtra, Map<String, Object> serverExtra) {
        interstitialAD = new UnifiedInterstitialAD(activity, sdkSupplier.adspotid, new UnifiedInterstitialADListener() {
    ...
    public void notifyBiddingResult(boolean isWin, double winPrice, Map<String, Object> referBidInfo) {
        ...
        GdtUtil.notifyBid(interstitialAD, isWin, winPrice, referBidInfo);
    }
}
