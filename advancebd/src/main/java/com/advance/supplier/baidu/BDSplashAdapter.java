...
public class BDSplashAdapter extends AdvanceSplashCustomAdapter  {
    ...
    public void loadAd(Context context, Map<String, Object> localExtra, Map<String, Object> serverExtra) {
        ...
        splashAd = new SplashAd(BYUtil.getCtx(), sdkSupplier.adspotid, parameters, new SplashInteractionListener() {
